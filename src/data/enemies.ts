...
export const BOSSES: Record<BossId, BossDef> = {
  ...
  emberjaw: {
    ...
    resist: ['ember'],
    moves: [
      { name: 'molten lunge', mult: 1.0 },
      {
        name: 'cinder spray',
        mult: 0.85,
        rider: { type: 'playerStatus', status: 'burning', chance: 0.35 },
      },
      { name: 'flare up', mult: 1.2 },
    ],
    intro: 'Emberjaw drags itself from the slag, jaws glowing.',
    sigilToast: 'Cinderwaste lieutenant felled.',
    special: {
      kind: 'enrage',
      belowHpFrac: 0.35,
      dmgMult: 1.4,
      weightedMove: 'flare up',
      enragedWeightMult: 2,
    },
  },
  pyrewarden: {
    ...
    resist: ['ember'],
    moves: [
      { name: 'pyre cleave', mult: 1.0 },
      {
        name: 'ashen breath',
        mult: 0.9,
        rider: { type: 'playerStatus', status: 'burning', chance: 0.35 },
      },
      { name: 'eruption', mult: 1.3 },
    ],
    intro: 'The Pyrewarden rises, wreathed in a fire that answers only to it.',
    sigilToast: 'The Ember of the Reaches is yours.',
    special: {
      kind: 'summonAndVeil',
      summonAtHpFrac: 0.6,
      summonSpecies: 'ashling',
      summonCount: 2,
      summonLv: 5,
      veilName: 'Cinder Veil',
      veilEvery: 4,
      veilShield: 28,
    },
  },
  ...
  rimehound: {
    ...
    resist: ['rime'],
    moves: [
      { name: 'frost lunge', mult: 1.0 },
      {
        name: 'biting cold',
        mult: 0.85,
        rider: { type: 'playerStatus', status: 'chilled', chance: 0.35 },
      },
      { name: 'pounce', mult: 1.2 },
    ],
    intro: 'Rimehound circles, breath fogging, ice cracking under its paws.',
    sigilToast: 'Hoarfrost lieutenant felled.',
    special: {
      kind: 'submerge',
      every: 3,
      voltMult: 2.0,
      breachName: 'Frostbite Lunge',
      breachMult: 1.5,
    },
  },
  hoarwarden: {
    ...
    resist: ['rime'],
    moves: [
      { name: 'glacial sweep', mult: 1.0 },
      {
        name: 'deepfreeze',
        mult: 0.9,
        rider: { type: 'playerStatus', status: 'chilled', chance: 0.4 },
      },
      { name: 'avalanche', mult: 1.3 },
    ],
    intro: 'The Hoarwarden takes shape from the cold, and the cold obeys.',
    sigilToast: 'The Rime of the Reaches is yours.',
    special: {
      kind: 'summonAndVeil',
      summonAtHpFrac: 0.6,
      summonSpecies: 'gloomwing',
      summonCount: 2,
      summonLv: 6,
      veilName: 'Hoarfrost Veil',
      veilEvery: 4,
      veilShield: 30,
    },
  },
  ...
  galecaller: {
    ...
    resist: ['volt'],
    moves: [
      { name: 'gale slash', mult: 1.0 },
      { name: 'static jolt', mult: 0.85, rider: { type: 'mpDrain', amount: 5 } },
      { name: 'downdraft', mult: 1.2 },
    ],
    intro: 'Galecaller throws its arms wide and the wind answers.',
    sigilToast: 'Stormreach lieutenant felled.',
    special: {
      kind: 'summonAndVeil',
      summonAtHpFrac: 0.6,
      summonSpecies: 'galeharrow',
      summonCount: 2,
      summonLv: 7,
      veilName: 'Static Veil',
      veilEvery: 4,
      veilShield: 30,
    },
  },
  tempest: {
    ...
    resist: [],
    moves: [
      { name: 'thunderhead', mult: 1.0 },
      { name: 'chain lightning', mult: 0.9, rider: { type: 'mpDrain', amount: 6 } },
      { name: 'cyclone', mult: 1.3 },
    ],
    intro: 'The Tempest Warden gathers the whole sky into itself.',
    sigilToast: 'The Storm of the Reaches is yours.',
    special: {
      kind: 'attune',
      attunedMult: 1.8,
      otherMult: 0.85,
