...
export const RUNES: Record<RuneId, RuneDef> = {
  ...
  weight: {
    id: 'weight',
    label: 'Weight',
    blurb: 'A crushing blow, but the page drinks deep. Bring spare MP.',
    mp: 2.2,
    suffix: ' of Weight',
    pw: 1.8,
  },
  ruin: {
    id: 'ruin',
    label: 'Ruin',
    blurb: 'Rarely connects on the seam, but when it does, it ruins.',
    mp: 1.35,
    suffix: ' of Ruin',
    crit: { chance: 0.15, mult: 2.2 },
  },
  ward: {
    id: 'ward',
    label: 'Ward',
    blurb: 'Light damage, heavy mark. A cheap way to set up the Wheel.',
    mp: 0.9,
    suffix: ' of Warding',
    pw: 0.75,
    procBonus: 0.3,
